...
import Logo from '../public/images/dawood-emran-logo.svg'
          ...
          <li>
            <Link href="" legacyBehavior>
              <a title='My Twitter' target="_blank">
                <svg
                  className='transition-transform hover:scale-125 duration-300 text-1 hover:text-2'
